...
export const ContributionForm = ({
  ...
  const handleStartReview = useCallback(() => {
    ...
    // Reset the changeset to start with a clean review
    // The user will see the stacked entity as the base, but their changes
    // will be tracked separately as a new review
